...
export default function Aboutus() {
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/}
      <div
        className="page-title-area bg-primary"
        style={{ backgroundImage: 'url("assets/images/shape/shape-dot1.png")' }}
      >
            ...
            <div className="col-lg-6">
              <div className="about-mock-up-thumb">
                <div className="mock-up-thumb" data-animate="hg-fadeInLeft">
                  <img
                    src="appassets/images/about/about1.jpg"
                    alt="Thumbnail"
                  />
                </div>
                {/* /.mock-up-thumb */}
                <div className="mock-up-thumb" data-animate="hg-fadeInLeft">
                  <img
                    src="appassets/images/about/about2.jpg"
                    alt="Thumbnail"
                  />
                </div>
                {/* /.mock-up-thumb */}
              ...
              {/* /.about-mock-up-thumb */}
              <div
                className="experience-info-area bg-image bg-overlay-primary"
                style={{
                  backgroundImage:
                    'url("https://e-capitaloption.com/appassets/images/bg/experiance-bg.jpg")',
                }}
                ...
                <div className="section-title">
                  ...
                  <div className="title-text" data-animate="hg-fadeInUp">
                    <p style={{ textAlign: "justify" }}>
                      ...
                      platform, we have now expanded our offerings to include
                      CFDs on stocks and ETFs, Forex trading, and the exclusive
                      IQOption product called Digital Options.
                    </p>
                    <p style={{ textAlign: "justify" }}>
                      First founded in 2013, Rillbit Option has grown massively,
                      and now has over 40 million members and counting! The
                      platform itself has also undergone some changes since
                      2013, and we are constantly working to ensure it is fast,
                      accurate and easy to use.
                    </p>
                    <p style={{ textAlign: "justify" }}>
                      We have also refined our offering and introduced plenty of
                      new products in our bid to continue giving our customers
                      the ultimate online trading experience and to help them
                      optimize their investment portfolio. Now, using our
                      platform, our members can try CFDs on currency pairs, CFDs
                      on stocks, CFDs on commodities, CFDs on cryptocurrencies,
                      CFDs on ETFs, as well as Binary and Digital Options.
                    </p>
                  </div>
                  {/* /.title-text */}
                </div>
                  ...
                  <div className="single-info" data-animate="hg-fadeInUp">
                    ...
                    <div className="info">
                      <p style={{ textAlign: "justify" }}>
                        ...
                        qualities. It is impossible to achieve absolute
                        perfection in trading. There is no limit to the amount
          ...
          <div className="row">
            <div className="col-12">
              <div className="our-vision-content-area">
                <div
                  className="our-vision-content bg-image"
                  style={{
                    backgroundImage:
                      'url("https://e-capitaloption.com/appassets/images/shape/shape-dot2.png")',
                  }}
                >
                  <div className="element-effect">
                    <img
                      className="line"
                      src="appassets/images/vactor/line2.png"
                      alt="Icon"
                    />
                    <img
                      className="triangle"
                      src="appassets/images/vactor/triangle2.png"
                      alt="Icon"
                    />
                    <img
                      className="rectangle"
                      src="appassets/images/vactor/rectangle.png"
                      alt="Icon"
                    />
                    <img
                      className="circle"
                      src="appassets/images/vactor/circle.png"
                      alt="Icon"
                    />
                  </div>
                  {/* /.element-effect */}
                    ...
                    <div className="card-info-one" data-animate="hg-fadeInUp">
                      ...
                      <div className="info">
                        ...
                        <p style={{ textAlign: "justify" }}>
                          ...
                          notifications, real-time market data, orders and
                          balance statuses at your fingertips.
                        </p>
                      </div>
                      {/* /.info */}
                    </div>
                ...
                <div className="vision-thumb-area" data-animate="hg-fadeInLeft">
                  <img
                    src="appassets/images/others/vision-thumb.png"
                    alt="Thumb"
                  />
                </div>
              </div>
      ...
      <div className="investor-block pd-b-120" style={{ paddingTop: 120 }}>
        <div className="container ml-b-5">
          ...
          <div className="row">
            <div className="col-12">
              <div
                className="investor-carousel owl-carousel"
                data-animate="hg-fadeInUp"
              >
                <div className="investor-item">
                  <figure className="investor-thumb">
                    <img
                      src="appassets/images/investor/1.jpg"
                      alt="Sport Thumb"
                    />
                ...
                <div className="investor-item">
                  <figure className="investor-thumb">
                    <img
                      src="appassets/images/investor/2.jpg"
                      alt="Sport Thumb"
                    />
                ...
                <div className="investor-item">
                  <figure className="investor-thumb">
                    <img
                      src="appassets/images/investor/3.jpg"
                      alt="Sport Thumb"
                    />
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/}
      <div
        className="discount-block ptb-120 bg-image bg-overlay-primary"
        style={{
          backgroundImage:
            'url("https://e-capitaloption.com/appassets/images/bg/discount-bg.jpg")',
        }}
      >
        <div className="container">
            ...
            <div className="col-lg-8">
              <div className="discount-content text-white text-center">
                ...
                <div className="discount-btn-group" data-animate="hg-fadeInUp">
                  <a href="/register" className="btn btn-default btn-white">
                    Get Started Now
                  </a>
                </div>
                {/* /.action-btn-group */}
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/}
      <div
        className="testimonial-block pd-t-120 "
      ...
      >
        <div className="container">
            ...
            <div className="col-lg-10">
              <div className="section-title text-center">
                ...
                <div className="title-text" data-animate="hg-fadeInUp">
                  ...
                  they have had a lot of nice things to say about us. Here's
                  what our users think about Rillbit Option, in their own words.
                </div>
                {/* /.title-text */}
              </div>
              {/* /.section-title */}
          ...
          <div className="row justify-content-center">
            <div className="col-12">
              <div
                className="testimonail-carousel-main"
                data-animate="hg-fadeInUp"
              >
                <div id="testimonail-carousel" className="owl-carousel">
                  <div className="testimonial-item">
                    <div className="client-area">
                      <div className="thumbnails">
                        <img
                          src="appassets/images/testimonials/one/1.png"
                          alt="img"
                        />
                      </div>
                      {/* /.thumbnails */}
                    ...
                    <div className="details">
                      <p>
                        Rillbit Option has made it extremely easy for me to make
                        an income trading online. In fact it is the only service
                        I use because of the smooth interface and large user
                        base.
                      </p>
                  ...
                  <div className="testimonial-item">
                    <div className="client-area">
                      <div className="thumbnails">
                        <img
                          src="appassets/images/testimonials/one/2.png"
                          alt="img"
                        />
                      </div>
                      {/* /.thumbnails */}
                    ...
                    <div className="details">
                      <p>
                        Being an Rillbit Option costumer has been great. Support
                  ...
                  <div className="testimonial-item">
                    <div className="client-area">
                      <div className="thumbnails">
                        <img
                          src="appassets/images/testimonials/one/3.png"
                          alt="img"
                        />
                      </div>
                      {/* /.thumbnails */}
                    ...
                    <div className="details">
                      <p>
                        Great looking website with all the possible ways to
                        trade cryptocurrency all over the world with quick and
                  ...
                  <div className="testimonial-item">
                    <div className="client-area">
                      <div className="thumbnails">
                        <img
                          src="appassets/images/testimonials/one/4.png"
                          alt="img"
                        />
                      </div>
                      {/* /.thumbnails */}
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/}
        <footer
          className="site-footer bg-primary pd-t-120"
          style={{
            backgroundImage:
              'url("https://e-capitaloption.com/appassets/images/shape/cloud-star.png")',
          }}
        >
          {/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                      ...
                      <div className="widget-content">
                        ...
                        <p style={{ textAlign: "justify" }}>
                          <font style={{ color: "white" }}>
                            ...
                            to include CFDs on stocks and ETFs, Forex trading,
                            and the exclusive Rillbit Option product called
                            Digital Options.
                          </font>
                        </p>
                      </div>
