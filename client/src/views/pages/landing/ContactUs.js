      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="https://eloquent-kowalevski-7a4ef7.netlify.app/#/login">Login</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://eloquent-kowalevski-7a4ef7.netlify.app/#/register">Register</a>
            </li>
          </ul>
        </div>
      </div>
