...
const handleScroll=() => {
        ...
        <div className="col-md-6 d-flex align-self-center">
          <div className="left">
            <div className="heading-title">
              <h2 style={{textAlign: 'justify'}}><span style={{color: '#02171a'}}><span style={{}}><span style={{fontFamily: 'times new roman,times,serif'}}>
          ...
          <div className="right">
            <div className="parallax1">
              <div className="containerCEO">
                <img className="img-fluid" alt="CEO" style={{width: '100%'}} src="appassets/newimages/CEO.jpg" />
                <div className="text-block">
                  <h4>
                    <font color="white">James dyson - CEO</font>
                  </h4>
                  <p>
                    <font color="white">We share the passion to code, create, and connect people to
                      the future of finance.</font>
                  </p>
                </div>
              </div>
            </div>
    ...
    <div className="container">
      <div className="row">
        <div className="col-12 text-center">
          <div className="heading-title">
            <p>
              Join the world’s most popular Trading Platform
            </p>
            <h2>
      ...
      <p style={{textAlign: 'justify', paddingBottom: 5}}>Our platform is designed and architected for all
        experience level of traders and arranged Intuitive, Comfortable, and Super User-friendly.
        Enjoy All Asset Class in one platform, Ultra-low Latency &amp; Fair Execution you've never met before!</p>
      <center>
        <img id="dog" src="appassets/newimages/banner1.png" alt="banner" align="middle" style={{width: '80%', height: 'auto'}} />
      </center>
    </div>
  </section>
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <img id="dog" src="appassets/newimages/s1.png" alt="Snow" align="middle" style={{width: '50%', height: 150}} />
            </center>
          </div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
            ...
            <p style={{textAlign: 'justify'}}>
              <font color="white">Free Bitcoin wallets are available for all major operating system and
                devices to serve a variety
                of your needs. Choosing a wallet is easy and can be done within a minute.</font>
            </p>
          </div>
        </div>
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <center><img id="dog" src="appassets/newimages/s2.png" alt="Snow" style={{width: '50%', height: 150}} /></center>
            </center></div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
              <h3 style={{paddingTop: 5}}>
            ...
            <p style={{textAlign: 'justify'}}>
              <font color="white">Now that you have a wallet, you have to add some Bitcoin to your
                balance.
                And have your Bitcoin cash wallet address ready for use.</font>
            </p>
          </div>
        </div>
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <center><img id="dog" src="appassets/newimages/s3.png" alt="Snow" style={{width: '50%', height: 150}} /></center>
            </center></div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
              <h3 style={{paddingTop: 5}}>
            ...
            <p style={{textAlign: 'justify'}}>
              <font color="white">Receiving Bitcoin is as easy as giving the sender your public address.
                Sending Bitcoin requires a few more steps.
                It is important to pay attention when sending. Overall, the process for sending Bitcoin
                is actually quite easy</font>
            </p>
          </div>
        </div>
      </div>
      <style dangerouslySetInnerHTML={{__html: "\n\t\t\t\t.buttonGet {\n\t\t\t\t\tbackground-color: #fff;\n\t\t\t\t\tborder: none;\n\t\t\t\t\tcolor: #fbae1c;\n\t\t\t\t\tpadding: 15px 25px;\n\t\t\t\t\ttext-align: center;\n\t\t\t\t\tfont-size: 16px;\n\t\t\t\t\tcursor: pointer;\n\t\t\t\t\tborder-radius: 20px;\n\t\t\t\t}\n\n\t\t\t\t.buttonGet:hover {\n\t\t\t\t\tbackground-color: #fff;\n\t\t\t\t\tborder-radius: 10px;\n\t\t\t\t}\n\t\t\t" }} />
      <center><a className="nav-link" href="/register"><button className="buttonGet">Register Now</button></a>
      </center>
        ...
        <div className="col-md-6">
          <div className="right">
            <div className="parallax2">
              <img className="img-fluid" src="appassets/newimages/sponsors1.png" alt="img" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <img id="dog" src="appassets/newimages/a6.png" alt="Snow" align="middle" style={{width: '30%', height: 80}} />
            </center>
          </div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
        ...
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <img id="dog" src="appassets/newimages/a2.png" alt="Snow" align="middle" style={{width: '30%', height: 80}} />
            </center>
          </div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
            ...
            <p style={{textAlign: 'justify'}}>
              <font color="white">
                Our support service is 24/7 available for you. If you have any query, kindly contact us.
                We are happy to help you.</font>
            </p>
          </div>
        </div>
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <img id="dog" src="appassets/newimages/a3.png" alt="Snow" align="middle" style={{width: '30%', height: 80}} />
            </center>
          </div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
            ...
            <p style={{textAlign: 'justify'}}>
              <font color="white">Get the latest Bitcoin price with our real-time price charts including
                buy and sell volumes.</font>
            </p>
          </div>
        </div>
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <img id="dog" src="appassets/newimages/a4.png" alt="Snow" align="middle" style={{width: '30%', height: 80}} />
            </center>
          </div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
        ...
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <img id="dog" src="appassets/newimages/a1.png" alt="Snow" align="middle" style={{width: '30%', height: 80}} />
            </center>
          </div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
        ...
        <div className="column">
          <div style={{background: 'white', padding: '20px 0px', borderRadius: '10px 10px 0px 0px'}}>
            <center>
              <img id="dog" src="appassets/newimages/a5.png" alt="Snow" align="middle" style={{width: '30%', height: 80}} />
            </center>
          </div>
          <div style={{backgroundColor: 'rgba(255, 255, 255, 0.10)', borderRadius: '0px 0px 10px 10px', marginTop: 0, paddingTop: 5, paddingRight: 30, paddingLeft: 30, paddingBottom: 20}}>
            <center>
            ...
            <p style={{textAlign: 'justify'}}>
              <font color="white">Security of user information and funds is our first priority. Our
                security team is continually improving our end-to-end security measures, improving
                auditing processes, and reducing the 'attack surface' of our infrastructure.</font>
            </p>
          </div>
        </div>
      </div>
  ...
  <section id="counter">
    <div className="heading-title2" style={{paddingBottom: 30}}>
      <center>
        ...
        <h5>
          <font style={{color: 'black'}}>FDs on Stocks, ETFs, Commodities, Indices, Cryptocurrencies, Forex and
            Options</font>
        </h5>
      </center>
    </div>
    <img src="appassets/newimages/video2.webp" alt="video" style={{width: '100%'}} />
  </section>
  {/* Counter Area End */}
  {/* FAQ Area Start */}
  <section id="faq">
      ...
      <div className="row">
        <div className="col-12 text-center">
          <div className="heading-title2">
            ...
            <h5>
              <font color="white">
                We answer some of your Frequently Asked Questions regarding bitcoin and bitcoin cloud
                mining via email and contact us page.
                If you have a query regarding bitcoin mining do not hesitate to kindly contact us.
              </font>
            </h5>
          </div>
        </div>
                ...
                <div className="col-md-6">
                    ...
                    <div className="panel panel-default">
                      <div className="panel-heading" id="headingTwo">
                        <h4 className="panel-title">
                          <a className="collapsed" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                            Why is Bitcoin Trusted?</a>
                        </h4>
                      </div>
                      <div id="collapse2" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionId">
                        <div className="panel-body">
                          Bitcoin is trusted widely because it’s open-source and
                          decentralized. This means that the global public has access to the
                          entire Bitcoin source code at any time. All payments
                          can be made without reliance on a third-party and the whole system
                          is protected by heavily peer-reviewed cryptographic algorithms and
                          most important thing is no institution
                          or organization can control Bitcoin.
                        </div>
                      </div>
                    </div>
                    <div className="panel-heading" id="headingOne">
                      <h4 className="panel-title">
                        <a className data-toggle="collapse" data-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
                          What is the minimum amount for withdrawal?</a>
                      </h4>
                    </div>
                    <div id="collapse1" className="collapse" aria-labelledby="headingOne" data-parent="#accordionId">
                      <div className="panel-body">
                  ...
                  <div className="panel panel-default">
                    <div className="panel-heading" id="headingThree">
                      <h4 className="panel-title">
                        <a className="collapsed" data-toggle="collapse" data-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                          I haven't found an answer to my question. How can I get in touch
                          with you?</a>
                      </h4>
                    </div>
                    <div id="collapse3" className="collapse" aria-labelledby="headingThree" data-parent="#accordionId">
                      <div className="panel-body">
                        Customer service is our highest priority. Therefore you can get in touch
                  ...
                  <div className="panel panel-default">
                    <div className="panel-heading" id="headingFour">
                      <h4 className="panel-title">
                        <a className="collapsed" data-toggle="collapse" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                          How can I make an investment?</a>
                      </h4>
                    </div>
                    <div id="collapse4" className="collapse" aria-labelledby="headingFour" data-parent="#accordionId">
                      <div className="panel-body">
                        To make an investment with us simply choose the investment plan or click
                        on register and you will be redirected to the registration page. After
                        you have completed registration, navigate to account funding section to
                        deposit money into your account. After you have successfully funded your
                        account, purchase any of our investment plans and wait for your daily or
                        hourly profits.
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-md-6">
                  <div className="panel panel-default">
                    <div className="panel-heading" id="headingFive">
                      <h4 className="panel-title">
                        <a className data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                          What’s the minimum amount I can invest?</a>
                      </h4>
                    </div>
                    <div id="collapse5" className="collapse" aria-labelledby="headingFive" data-parent="#accordionId">
                      <div className="panel-body">
                        For the Basic plan the minimum amount is 100 USD, for the Premium plan
                        it’s 1000 USD and for the Ultimate plan it’s 10,000 USD.
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default">
                    <div className="panel-heading" id="headingSix">
                      <h4 className="panel-title">
                        <a className="collapsed" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                          Do you have a referral program?</a>
                      </h4>
                    </div>
                    <div id="collapse6" className="collapse" aria-labelledby="headingSix" data-parent="#accordionId">
                      <div className="panel-body">
                        Free Money? Sure, why not! If you’re bringing in friends/family you can
                        get up to 10% more to your return per each plan your referral invest.
                        The payment is made instantly to your account balance after the
                        investment cycle has been completed. For more information, please visit
                        our Referrals Section.
                      </div>
                    </div>
                  </div>
                  <div className="panel panel-default">
                    <div className="panel-heading" id="headingSeven">
                      <h4 className="panel-title">
                        <a className="collapsed" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
                          What is BItcoin mining?</a>
                      </h4>
                    </div>
                    <div id="collapse7" className="collapse" aria-labelledby="headingSeven" data-parent="#accordionId">
                      <div className="panel-body">
                        ...
                        or hash functions. These problems help miners to confirm blocks of
                        transactions held within the network. Bitcoin mining provides a reward
                        for miners by paying out in Bitcoin in turn the miners confirm
                        transactions on the blockchain. Miners introduce new Bitcoin into the
                        network and also secure the system with transaction confirmation. They
                        are also rewarded network fees for when they harvest new coin and a time
                  ...
                  <div className="panel panel-default">
                    <div className="panel-heading" id="headingEight">
                      <h4 className="panel-title">
                        <a className="collapsed" data-toggle="collapse" data-target="#collapse8" aria-expanded="false" aria-controls="collapse8">
                          How does mining help secure Bitcoin?
                        </a>
                      </h4>
                    </div>
                    <div id="collapse8" className="collapse" aria-labelledby="headingEight" data-parent="#accordionId">
                      <div className="panel-body">
  ...
  {/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      Start Site Footer
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/}
  <footer className="site-footer pd-t-120" style={{    backgroundColor: '#02171a',color:'white'}}>
    {/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
